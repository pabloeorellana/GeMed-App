// server/controllers/clinicalRecordController.js
import { format } from 'date-fns';

// @desc    Obtener todas las entradas de HC de un paciente
// @route   GET /api/patients/:patientId/clinical-records
// @access  Privado
...
// @desc    Crear una nueva entrada de HC
// @route   POST /api/patients/:patientId/clinical-records
// @access  Privado
...
// @desc    Actualizar una entrada de HC
// @route   PUT /api/clinical-records/:recordId
// @access  Privado
...
// @desc    Eliminar una entrada de HC
// @route   DELETE /api/clinical-records/:recordId
// @access  Privado
