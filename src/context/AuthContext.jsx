...
export const AuthProvider = ({ children }) => {
        ...
        if (token && userDataString) {
            try {
                ...
                if (user && user.id) { // Verificar que el usuario y su ID existan
                    ...
                    // Limpiar storage si los datos son inválidos
    ...
    const login = (data) => { // data = { token, user } de la API
    ...
    // console.log('AUTH_CONTEXT: Renderizando Provider, isAuthenticated:', !!authUser, 'loadingAuth:', loadingAuth);
